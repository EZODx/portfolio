...
private:
	...
	static stTransferRecord _ConvertTransferLineToRecord(string line, string separator = "#//#")
	{
		...
		transferLogRecord.srcBalanceAfter = stod(transferLogDataLine[3]);
		transferLogRecord.desBalanceAfter = stod(transferLogDataLine[4]);
		transferLogRecord.amount = stod(transferLogDataLine[5]);

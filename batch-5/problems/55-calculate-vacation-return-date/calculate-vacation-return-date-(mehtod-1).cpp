...
sDate VacationReturnDate(sDate dateFrom, short vacationDays)
{
	...
	// In case the date is a weekend, keep adding one day until you reach a business day.
	// This removes weekends before the first business day.
	while (IsWeekEnd(dateFrom))
	{
		dateFrom = IncreaseDateByOneDay(dateFrom);
	}

	// Here we increase the vacation days and account for weekends.
